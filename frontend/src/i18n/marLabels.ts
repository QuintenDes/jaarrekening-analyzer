...
/** VOL combined codes sometimes appear as the MIC short form. */
...
export const MAR_LABELS: Record<string, MarLabel> = {
  ...
  "30": L("Raw materials and consumables", "Grond- en hulpstoffen", "Approvisionnements"),
  "31": L("Work in progress", "Goederen in bewerking", "En-cours de fabrication"),
  "32": L("Finished goods", "Gereed product", "Produits finis"),
  "33": L("Goods purchased for resale", "Handelsgoederen", "Marchandises"),
  "34": L("Immovable property intended for sale", "Onroerende goederen bestemd voor verkoop", "Immeubles destinés à la vente"),
  "35": L("Advance payments", "Vooruitbetalingen", "Acomptes versés"),
  ...
  "14P": L("Accumulated profits (losses)", "Overgedragen winst (verlies)", "Bénéfice (Perte) reporté(e)"),
  ...
  "19": L("Provisions and deferred taxes", "Voorzieningen en uitgestelde belastingen", "Provisions et impôts différés"),
  ...
  "172/3": L("Leasing and similar obligations", "Leasingschulden en soortgelijke", "Dettes de location-financement et assimilées"),
  "174": L("Credit institutions", "Kredietinstellingen", "Établissements de crédit"),
  "175": L("Other loans", "Overige leningen", "Autres emprunts"),
  "176": L("Trade debts", "Handelsschulden", "Dettes commerciales"),
  ...
  "46": L("Advances received on contracts in progress", "Vooruitbetalingen op bestellingen", "Acomptes reçus sur commandes"),
  ...
  "71": L(
    ...
    "Voorraad goederen in bewerking en bestellingen in uitvoering: toename (afname)",
  ...
  "75": L("Income from financial fixed assets", "Opbrengsten uit financiële vaste activa", "Produits des immobilisations financières"),
  "750": L("Income from current assets", "Opbrengsten uit vlottende activa", "Produits des actifs circulants"),
  "751": L("Other financial income", "Andere financiële opbrengsten", "Autres produits financiers"),
  "76B": L("Non-recurring financial income", "Niet-recurrente financiële opbrengsten", "Produits financiers non récurrents"),
  "65": L("Financial charges", "Financiële kosten", "Charges financières"),
  ...
  "9905": L("Transfer from untaxed reserves", "Onttrekking aan de belastingvrije reserves", "Prélèvements sur les réserves immunisées"),
  ...
  "794": L("Profit to be carried forward", "Over te dragen winst", "Bénéfice à reporter"),
